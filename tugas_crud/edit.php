  ...
  <body>
   ...
   <br>
    ...
    <div class="form-check">
         <label><input type="checkbox" name="olahraga_fav[]" value="Sepak Bola" 
         <?php if (in_array("Sepak Bola", $dataor)) echo "checked";?>>Sepak Bola</label><br>

         <label><input type="checkbox" name="olahraga_fav[]" value="Basket" 
         ...
         <label><input type="checkbox" name="olahraga_fav[]" value="Renang" 
